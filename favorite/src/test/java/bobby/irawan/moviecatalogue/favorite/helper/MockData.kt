...
//import bobby.irawan.moviecatalogue.core.data.remote.movie.model.ProductionCountryResponse
//import bobby.irawan.moviecatalogue.core.data.remote.movie.model.SpokenLanguageResponse
//import bobby.irawan.moviecatalogue.core.data.remote.tvshow.model.*
//import bobby.irawan.moviecatalogue.core.domain.model.FavoriteDomainModel
...
//    )
//    val successMovieResponse: SimpleBaseResponse<List<MovieResponse>> =
...
//    )
//    val successTvShowResponse: SimpleBaseResponse<List<TvShowResponse>> =
...
//        type = "tv_show"
//    )
//    val modelFavoriteTvShow = FavoriteDomainModel(
//        id = 1416,
//        title = "Grey's Anatomy",
//        releaseDate = "27 March 2005",
//        posterUrl = "https://image.tmdb.org/t/p/w342/clnyhPqj1SNgpAdeSS6a6fwE6Bo.jpg",
...
//        .setPageSize(10)
//        .build()
//    val dataSourceFactory = mockkClass(
